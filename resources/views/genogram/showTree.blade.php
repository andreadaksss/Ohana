...
<head>
    ...
    function init()
    {
        ...
        for (var i in tree)
        {
            ...
            if(user.mFirstname !== null && user.fFirstname !== null && user.sFirstname !== null && user.cFirstname !== null)
            {
            ...
            else if(user.mFirstname !== null && user.fFirstname !== null && user.sFirstname !== null && user.cFirstname === null)
            {
                setupDiagram(myDiagram,
                [
                    { key: 0, n: user.uFirstname, s: user.uGender, m: 1, f: 2, vir: 3 }, // user
    ...
    GenogramLayout.prototype.add = function(net, coll, nonmemberonly)
    {
        ...
        while (multiSpousePeople.count > 0)
        {
            ...
            marriages.each(function(link)
            {
                ...
                if (v !== null) { net.linkVertexes(dummyvert, v, null); }
            });
    ...
    GenogramLayout.prototype.commitNodes = function()
    {
        ...
        this.network.vertexes.each(function(v)
        {
            ...
            { // if only one child
                ...
                var overlaps = layout.diagram.findObjectsIn(newbnds, function(x) { return x.part; },
                    function(p) { return p !== v.node; }, true);
                if (overlaps.count === 0)
                {
